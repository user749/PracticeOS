...
./build/keyboard/classic.o: ./src/keyboard/classic.c
	i686-elf-gcc ${INCLUDES} -I./src/classic ${FLAGS} -std=gnu99 -c ./src/keyboard/classic.c -o ./build/keyboard/classic.o
